...
import ru.koshakmine.icstd.level.dimensions.CustomDimension;
...
public class Forest extends CustomDimension {

    @Override
    protected int getRegisterNumId() {
        return 75;
    };

    @Override
    public String getId() {
        return "infinite_forest";
    };

    @Override
    public float[] getSkyColor() {
        return new float[]{21 / 255, 96 / 255, 189 / 255};
    };

    @Override
    public float[] getFogColor() {
        return new float[]{0, 128 / 255, 0};
    };
